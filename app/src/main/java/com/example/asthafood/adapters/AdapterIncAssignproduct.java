...
public class AdapterIncAssignproduct extends RecyclerView.Adapter<AdapterIncAssignproduct.DueReportViewHolder> {

    private Context context;
    private ArrayList<SetGetIncAssignProduct> arrayList;

    public AdapterIncAssignproduct(Context context, ArrayList<SetGetIncAssignProduct> arrayList) {
