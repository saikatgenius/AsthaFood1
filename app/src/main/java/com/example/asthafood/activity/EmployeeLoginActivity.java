...
public class EmployeeLoginActivity extends AppCompatActivity {
    ...
    private void login() {
        if (!this.validate()) {
            ...
            final ProgressDialog progressDialog = new ProgressDialog(com.example.asthafood.activity.EmployeeLoginActivity.this,
                    ...
                    new Runnable() {
                        public void run() {
                            ...
                            if (um.isLoginAgentSuccessful(_userName, _password)) {
                                ...
                                Toast.makeText(com.example.asthafood.activity.EmployeeLoginActivity.this, "Invalid username or password.", Toast.LENGTH_SHORT).show();
                            }
                            // onLoginFailed();
    ...
    public void onBackPressed() {
        //super.onBackPressed();
        startActivity(new Intent(com.example.asthafood.activity.EmployeeLoginActivity.this, LoginOptionsActivity.class));
        overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
        finish();
    }
}