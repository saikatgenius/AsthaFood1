...
import com.example.asthafood.databinding.ActivityIncReturnProductBinding;
...
public class IncReturnProductActivity extends AppCompatActivity {
    ActivityIncReturnProductBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityIncReturnProductBinding.inflate(getLayoutInflater());
    ...
    private void SubmitData(ArrayList<SellProductDetailsModel> arrayList) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(IncReturnProductActivity.this,
        ...
        try {
            if (cn != null) {
                CallableStatement smt = cn.prepareCall("{call USP_ADROID_INSERT_RETURN_PRO_INC(?,?,?)}");
                ...
                if (ReturnERRORCode==0){
                    AlertDialog.Builder builder = new AlertDialog.Builder(IncReturnProductActivity.this);
                    ...
                    builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Intent i = new Intent(IncReturnProductActivity.this, IncDashboardActivity.class);
    ...
    private void getProducts(String userName) {
        ...
        try {
            if (cn != null) {
                CallableStatement smt = cn.prepareCall("{call ADROID_IncGetReturnItems(?)}");
                ...
                if (rs.isBeforeFirst()){
                    ...
                    sellProductDetailsAdapter = new SellProductDetailsAdapter( arrayList,IncReturnProductActivity.this,"ReturnProduct");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                startActivity(new Intent(IncReturnProductActivity.this, IncDashboardActivity.class));
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                finish();
                return true;
            default:
