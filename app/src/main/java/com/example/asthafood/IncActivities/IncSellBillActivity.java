...
import com.example.asthafood.adapters.AdapterIncBillReport;
...
public class IncSellBillActivity extends AppCompatActivity implements  View.OnClickListener {
    ...
    private AdapterIncBillReport adapterSellReport;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inc_sell_bill);
    ...
    public void onClick(View v) {
        if (v == mTv_tDate) {
            ...
            if (!mTv_fDate.getText().toString().isEmpty()) {
                ...
                Toast.makeText(IncSellBillActivity.this,"Please Enter From Date",Toast.LENGTH_LONG).show();
            ...
            if (!Edt_txtSearchShopkeeper.getText().toString().isEmpty()){
                ...
                Toast.makeText(IncSellBillActivity.this,"Please Enter Value",Toast.LENGTH_LONG).show();
    ...
    private void getShopkeeperID(String Value) {
        final ProgressDialog progressDialog = new ProgressDialog(IncSellBillActivity.this,
        ...
        try {
            if (cn != null) {
                ...
                if (rs.isBeforeFirst()){
                    ...
                    ArrayAdapter<String> arrayAdapter=new ArrayAdapter(IncSellBillActivity.this,R.layout.spinner_hint, arrayList_SCodeName);
                    activity_get_shopkeeper_list.setAdapter(arrayAdapter);
                    progressDialog.dismiss();
                }else{
                    progressDialog.dismiss();
                    Toast.makeText(IncSellBillActivity.this,"No Data Found",Toast.LENGTH_LONG).show();
                }
    ...
    private void selectFDate() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(IncSellBillActivity.this, new DatePickerDialog.OnDateSetListener() {
            @Override
        ...
        try {
            if (cn != null) {
                ...
                if (rs.isBeforeFirst()) {
                    ...
                    adapterSellReport = new AdapterIncBillReport(IncSellBillActivity.this, mArrayListSellReport);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                startActivity(new Intent(IncSellBillActivity.this, IncDashboardActivity.class));
