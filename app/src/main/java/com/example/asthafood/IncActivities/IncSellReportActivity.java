...
public class IncSellReportActivity extends AppCompatActivity implements View.OnClickListener {
     // toolbar
     ...
     protected void onCreate(Bundle savedInstanceState) {
       ...
       //  Toast.makeText(this, "IncSellReportActivity", Toast.LENGTH_SHORT).show();
         ...
         mToolbarTitle.setText("Inc Sell Report");
     ...
     private void selectFDate() {
         ...
         DatePickerDialog datePickerDialog = new DatePickerDialog(IncSellReportActivity.this, new DatePickerDialog.OnDateSetListener() {
             @Override
             ...
             public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                 ...
                 mArrayListSellReport.clear();
                  ...
                  if (mTv_fDate.getText().toString().isEmpty()) {
                      Toast.makeText(IncSellReportActivity.this, "Please Select From Date", Toast.LENGTH_SHORT).show();
                  }else {
        ...
        try {
            if (cn != null) {
                ...
                if (rs.isBeforeFirst()) {
                    ...
                    adapterSellReport = new AdapterSellReport(IncSellReportActivity.this, mArrayListSellReport);
     ...
     public boolean onOptionsItemSelected(MenuItem item) {
         switch (item.getItemId()) {
             case android.R.id.home:
                 ...
                 startActivity(new Intent(IncSellReportActivity.this, IncDashboardActivity.class));
