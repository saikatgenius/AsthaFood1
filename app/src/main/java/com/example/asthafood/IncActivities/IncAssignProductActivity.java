...
import com.example.asthafood.adapters.AdapterIncAssignproduct;
...
import com.example.asthafood.mssql.models.SetGetIncAssignProduct;
...
public class IncAssignProductActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private ArrayList<SetGetIncAssignProduct> mArrayListSellReport;
    private RecyclerView mRv_loanDueReport;
    private AdapterIncAssignproduct adapterSellReport;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_inc_assign_product);
        setViewReferences();
        bindEventHandlers();
    ...
    public void getLoanDueReport(String empcode, String date) {
        ...
        mArrayListSellReport.clear();
        SetGetIncAssignProduct setGetAssignProduct = null;
        ...
        try {
            if (cn != null) {
                CallableStatement smt = cn.prepareCall("{call ADROID_GetAssignProduct_Inc(?)}");
                ...
                if (rs.isBeforeFirst()) {
                    while (rs.next()) {
                        setGetAssignProduct = new SetGetIncAssignProduct();
                        ...
                        setGetAssignProduct.setAmount(rs.getString("IncEmpSellPrice"));
                    ...
                    adapterSellReport = new AdapterIncAssignproduct(IncAssignProductActivity.this, mArrayListSellReport);
    ...
    private void selectFDate() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(IncAssignProductActivity.this, new DatePickerDialog.OnDateSetListener() {
            @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                startActivity(new Intent(IncAssignProductActivity.this, IncDashboardActivity.class));
